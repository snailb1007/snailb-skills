...
- [ ] **INST-01**: Create `README.md` (or `.claude/README.md`) explaining setup, load order, override mechanisms, and project tag taxonomy.
- [ ] **INST-02**: Create an installer/updater script `bin/install-rules.mjs` that copies the `.claude/` config and linter to another workspace.
...
*Last updated: 2026-05-26 after Phase 5 definition*
